...
!function($) {
	...
	Datetimepicker.prototype = {
		...
		fillDow : function() {
			var dowCnt = this.weekStart, php = '<tr>';
			...
			for (var i = 0; i < 24; i++) {
				...
				if (this.showMeridian
					...
					if (meridian != meridianOld) {
						...
						php.push('<fieldset class="hour"><legend>'
								+ meridian.toUpperCase() + '</legend>');
					}
					meridianOld = meridian;
					txt = (i % 12 ? i % 12 : 12);
					php.push('<span class="hour' + clsName + ' hour_'
							+ (i < 12 ? 'am' : 'pm') + '">' + txt + '</span>');
					if (i == 23) {
						php.push('</fieldset>');
					}
					...
					txt = i + ':00';
					php.push('<span class="hour' + clsName + '">' + txt
							+ '</span>');
				}
			}
			...
			for (var i = 0; i < 60; i += this.minuteStep) {
				...
				if (this.showMeridian
					...
					if (meridian != meridianOld) {
						...
						php.push('<fieldset class="minute"><legend>'
								+ meridian.toUpperCase() + '</legend>');
					}
					meridianOld = meridian;
					txt = (hours % 12 ? hours % 12 : 12);
					// php.push('<span class="minute'+clsName+'
					// minute_'+(hours<12?'am':'pm')+'">'+txt+'</span>');
					php.push('<span class="minute' + clsName + '">' + txt
							+ ':' + (i < 10 ? '0' + i : i) + '</span>');
					if (i == 59) {
						php.push('</fieldset>');
					}
					...
					php.push('<span class="minute' + clsName + '">' + hours
							+ ':' + (i < 10 ? '0' + i : i) + '</span>');
				}
			}
